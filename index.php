...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img width="100px" class="img-rounded" src="images1/logo.png" alt=""> </a>
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"> <a class="nav-link active" href="index.php">Home <span class="sr-only">(current)</span></a> </li>
                            <li class="nav-item"> <a class="nav-link active" href="restaurants.php">Brand <span class="sr-only"></span></a> </li>
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images1/main.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Rent a camera, capture the world! </h1>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Choose Brand</h4> </div>
                        <!-- end:Step -->
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span>Delivery on time</h4> </div>
                        <!-- end:Step -->
                    </div>
                    <!-- end:Steps -->
                </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Popular equipment of the Month</h2>
                    <p class="lead">The easiest way to capture your core memeory</p>
                </div>
                <div class="row">
						                       ...
						                       echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
														<div class="food-item-wrap">
															...
															<div class="content">
																...
																<div class="price-btn-block"> <span class="price">$'.$r['price'].'</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Rent Now</a> </div>
															</div>
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <p>We"ve got your covered with popular brand</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Choose a Equipment & Rent it</h3>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <p>Get delivered! And enjoy! Pay online or pay on delivery</p>
                            </div>
                        </div>
                    </div>
                </div>
														...
														<div class="restaurant-wrap">
															<div class="row">
																<div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
																	<a class="restaurant-logo" href="dishes.php?res_id='.$rows['rs_id'].'" > <img src="'.$rows['image'].'" alt="Restaurant logo"> </a>
																</div>
																<!--end:col -->
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img width="100px" src="images1/logo.png" alt="Footer logo"> </a> <span>Rent a camera, capture the world!</span> </div>
