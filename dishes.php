        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.html"> <img width="100px" class="img-rounded" src="images1/logo.png" alt=""> </a>
        ...
        <div class="page-wrapper">
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="restaurants.php">Choose Brand</a></li>
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>">Pick Your favorite Camera</a></li>
                        <li class="col-xs-12 col-sm-4 link-item"><span>3</span><a href="#">Rent and Pay online</a></li>
                    </ul>
                </div>
            </div>
            <!-- end:Top links -->
			...
			<?php $ress= mysqli_query($db,"select * from restaurant where rs_id='$_GET[res_id]'");
									     $rows=mysqli_fetch_array($ress);
										  ...
										  ?>
            <section class="inner-page-hero bg-image" data-image-src="images1/main2.jpeg">
                <div class="profile">
                    <div class="container">
                        <div class="row">
...
?>								  
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                        ...
                        <div class="menu-widget" id="2">
                            <div class="widget-heading">
                                <h3 class="widget-title text-dark">
                              POPULAR Camera's <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular2" aria-expanded="true">
